...
//MyWpListTable{table_name} like TmmDesredMahaAdhiveshan

if( ! class_exists( 'WP_List_Table' ) ) {
    require_once( ABSPATH . 'wp-admin/includes/class-wp-list-table.php' );
}

class TmmDesredMahaAdhiveshan extends WP_List_Table{
    ...
    public function process_bulk_action() { 
        ...
        if ( 'trash' === $this->current_action() ) {
            ...
            if ( ! wp_verify_nonce( $nonce, 'sp_nonce_customer' ) ) {
                ...
                /*$pp = admin_url().'admin.php?page=tmm-desred-maha-adhiveshan';
                wp_redirect($pp);
                exit;*/
            }
    ...
    private function table_data(){ 
        ...
        $sql = "SELECT * FROM {$wpdb->prefix}tmm_maha_adhiveshan_tb";
    ...
    */
    public function column_lm_number( $item ) {
        ...
        if ($current == 'trash') {
            ...
            $actions = [
                ...
                'view' => '<a class="view_data" href="#" data-ID="'.$item['ID'].'" data-tbn="tmm_maha_adhiveshan_tb" data-sourse-type="">View</a>',
            ];
    ...
    public function get_sortable_columns(){ 
        return array(
            ...
            'fee_amount' => array('fee_amount', false),
            'reg_acount' => array('reg_acount', false),
    ...
    function extra_tablenav( $which ) {
        ...
        if ( $which == "top" ){   
            get_filter_by_colum_name($this->get_columns(), 'tmm_maha_adhiveshan_tb');
        }
        if ( $which == "bottom" ){
