...
//MyWpListTable{table_name} like TmmDesredBuildingFund

if( ! class_exists( 'WP_List_Table' ) ) {
    require_once( ABSPATH . 'wp-admin/includes/class-wp-list-table.php' );
}

class TmmDesredBuildingFund extends WP_List_Table{
    ...
    public function process_bulk_action() { 
        ...
        if ( 'trash' === $this->current_action() ) {
            ...
            if ( ! wp_verify_nonce( $nonce, 'sp_nonce_customer' ) ) {
                ...
                /*$pp = admin_url().'admin.php?page=tmm-desred-building-fund';
                wp_redirect($pp);
                exit;*/
            }
    ...
    private function table_data(){ 
        ...
        $sql = "SELECT * FROM {$wpdb->prefix}tmm_building_fund_tb";
    ...
    */
    public function column_lm_number( $item ) {
        ...
        if ($current == 'trash') {
            ...
            $actions = [
                ...
                'view' => '<a class="view_data" href="#" data-ID="'.$item['ID'].'" data-tbn="tmm_building_fund_tb" data-sourse-type="">View</a>',
            ];
    ...
    public function get_sortable_columns(){ 
        return array(
            ...
            'p_no' => array('p_no', false),
            'grad' => array('grad', false),
    ...
    function extra_tablenav( $which ) {
        ...
        if ( $which == "top" ){   
        get_filter_by_colum_name($this->get_columns(), 'tmm_building_fund_tb');
        }
        if ( $which == "bottom" ){
