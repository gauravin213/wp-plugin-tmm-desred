...
//MyWpListTable{table_name} like TmmDesredFamilyWelfareScheme

if( ! class_exists( 'WP_List_Table' ) ) {
    require_once( ABSPATH . 'wp-admin/includes/class-wp-list-table.php' );
}

class TmmDesredFamilyWelfareScheme extends WP_List_Table{
    ...
    public function process_bulk_action() { 
        ...
        if ( 'trash' === $this->current_action() ) {
            ...
            if ( ! wp_verify_nonce( $nonce, 'sp_nonce_customer' ) ) {
                ...
                /*$pp = admin_url().'admin.php?page=tmm-desred-family-welfare-scheme';
                wp_redirect($pp);
                exit;*/
            }
    ...
    private function table_data(){ 
        ...
        $sql = "SELECT * FROM {$wpdb->prefix}tmm_family_welfare_scheme_tb";
    ...
    */
    public function column_lm_number( $item ) {
        ...
        if ($current == 'trash') {
            ...
            $actions = [
                ...
                'view' => '<a class="view_data" href="#" data-ID="'.$item['ID'].'" data-tbn="tmm_family_welfare_scheme_tb" data-sourse-type="">View</a>',
            ];
    ...
    function extra_tablenav( $which ) {
        ...
        if ( $which == "top" ){   
            get_filter_by_colum_name($this->get_columns(), 'tmm_family_welfare_scheme_tb');
        }
        if ( $which == "bottom" ){
